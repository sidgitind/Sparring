...
```
1. Google PM           personas/pm/google-pm-data-driven.md
2. Google Architect    personas/architect/google-distributed-architect.md
3. QA Functional       personas/qa-functional/qa-functional-path-coverage.md  [user-facing only]
4. QA NFQ              personas/qa-nonfunctional/qa-nfq-resilience.md
```
