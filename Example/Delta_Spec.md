...
>
> **Pipeline mode used in this example: detailed, with @Synthesis (v1.2).**
...
>
> **Start here:** The SPARRING BRIEF (Tier 1 + Tier 2 from @Synthesis) is in
> `SPARRING_BRIEF.md` in this folder. Read that first — it is the 30-second
> entry point into everything documented here.
>
